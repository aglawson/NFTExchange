...
const MARKETPLACE_CONTRACT_ADDRESS = "0x953B46FDBBACe9eedE8081c3b9B438B6E8E383F2";
...
renderUserItem = async (item) => {
    ...
    userItem.getElementsByTagName("button")[1].onclick = () => {
        ...
        item.destroy();
        //marketplaceContract.methods.removeItem(item.token_id).send({from: userAddress});
    }
